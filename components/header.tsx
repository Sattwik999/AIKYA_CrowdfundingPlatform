    ...
    <header className="relative flex items-center justify-between px-4 py-2 md:px-6 lg:px-8 bg-gradient-to-r from-blue-50 via-cyan-50 to-teal-50 backdrop-blur-sm border-b border-cyan-100/50 shadow-sm">
      ...
      <Link href="/" className="relative flex items-center gap-3 group" prefetch={false}>
        <div className="relative flex items-center gap-1">
          {/* Multiple logo images with staggered animation */}
          ...
          {/* <div className="relative -ml-2">
            <img src="/aikya-logo.png" alt="AIKYA Logo" className="h-10 w-12 transition-all duration-300 group-hover:scale-105 opacity-70 group-hover:opacity-85" />
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/15 to-blue-400/15 rounded-full blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </div>
          <div className="relative -ml-2">
            <img src="/aikya-logo.png" alt="AIKYA Logo" className="h-8 w-10 transition-all duration-300 group-hover:scale-100 opacity-50 group-hover:opacity-75" />
            <div className="absolute inset-0 bg-gradient-to-r from-teal-400/15 to-cyan-400/15 rounded-full blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </div> */}
        </div>
      ...
      <div className="relative flex items-center gap-3">
        ...
        <Button 
          variant="ghost" 
          size="sm"
          className="hidden md:inline-flex h-9 w-9 p-0 text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-all duration-300"
        >
            ...
            {isAuthenticated ? (
              <>
                ...
                <Button
                  ...
                  className="hidden md:inline-flex h-9 w-9 p-0 text-gray-600 hover:text-red-600 hover:bg-red-50 transition-all duration-300"
                >
              ...
              <Button 
                variant="ghost" 
                className="hidden md:inline-flex text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-300"
        ...
        <Sheet>
          ...
          <SheetContent side="right" className="bg-gradient-to-b from-blue-50 to-teal-50">
